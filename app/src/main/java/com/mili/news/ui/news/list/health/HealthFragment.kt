package com.mili.news.ui.news.list.health
...
import com.mili.news.databinding.HealthFragmentBinding
...
class HealthFragment(private val viewModel: NewsSharedViewModel) : Fragment(), NewsClickInterface {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        InternetStatus(requireContext()).observe(viewLifecycleOwner, Observer { status ->
            viewModel.getNewsArticles(GlobalConstants.CATEGORY_HEALTH, status).observe(
