package com.mili.news.ui.news.list.business
...
import com.mili.news.databinding.BusinessFragmentBinding
...
class BusinessFragment(private val viewModel: NewsSharedViewModel) : Fragment(), NewsClickInterface {
