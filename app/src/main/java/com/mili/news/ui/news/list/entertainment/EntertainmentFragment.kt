package com.mili.news.ui.news.list.entertainment
...
import com.mili.news.databinding.EntertainmentFragmentBinding
...
class EntertainmentFragment(private val viewModel: NewsSharedViewModel) : Fragment(), NewsClickInterface {
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.entertainment_fragment, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        InternetStatus(requireContext()).observe(viewLifecycleOwner, Observer { status ->
            viewModel.getNewsArticles(GlobalConstants.CATEGORY_ENTERTAINMENT, status).observe(
