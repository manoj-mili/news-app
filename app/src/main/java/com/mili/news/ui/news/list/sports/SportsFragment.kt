package com.mili.news.ui.news.list.sports
...
import com.mili.news.databinding.SportsFragmentBinding
...
class SportsFragment(private val viewModel: NewsSharedViewModel) : Fragment(), NewsClickInterface {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        InternetStatus(requireContext()).observe(viewLifecycleOwner, Observer { status ->
            viewModel.getNewsArticles(GlobalConstants.CATEGORY_SPORTS, status).observe(
