package com.mili.news.ui.news.list.science
...
import com.mili.news.databinding.ScienceFragmentBinding
...
class ScienceFragment(private val viewModel: NewsSharedViewModel) : Fragment(), NewsClickInterface {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        InternetStatus(requireContext()).observe(viewLifecycleOwner, Observer { status ->
            viewModel.getNewsArticles(GlobalConstants.CATEGORY_SCIENCE, status).observe(
